...
var _bearOverflow = require("./utils/bear-overflow");
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    _bearOverflow.resizeObject.observe(navigationList);

    // eslint-disable-next-line no-unused-vars, no-undef
    var trainersSwiper = new Swiper('.trainers__swiper-container', {
    ...
    // eslint-disable-next-line no-unused-vars, no-undef
    var reviewsSwiper = new Swiper('.reviews__swiper-wrapper', {
      direction: 'horizontal',
      slidesPerView: 1,
      spaceBetween: 70,
      navigation: {
...
},{"./modules/form-validate/form":3,"./utils/bear-overflow":9,"./utils/ios-vh-fix":11,"./vendor/init-tabs":12}],2:[function(require,module,exports){
"use strict";
...
var resizeObject = new ResizeObserver(function (elements) {
  function bearOverflow() {
    if (height >= 100) {
      var heroSection = document.querySelector('[data-intro-section]');
      var additionalPadding = height;
